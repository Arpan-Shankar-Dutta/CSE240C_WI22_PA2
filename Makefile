...
all: bin/champsim_shipPlusPlus_maxSHCTR_3
...
clean: 
	...
	$(RM) inc/ooo_cpu_modules.inc
	 ...
	 find replacement/shipPlusPlus -name \*.o -delete
	 find replacement/shipPlusPlus -name \*.d -delete
...
bin/champsim_shipPlusPlus_maxSHCTR_3: $(patsubst %.cc,%.o,$(wildcard src/*.cc)) obj/repl_rreplacementDshipPlusPlus.a obj/pref_pprefetcherDno.a obj/repl_rreplacementDlru.a obj/pref_pprefetcherDno_instr.a obj/bpred_bbranchDbimodal.a obj/btb_bbtbDbasic_btb.a
	$(CXX) $(LDFLAGS) -o $@ $^ $(LDLIBS)

replacement/shipPlusPlus/%.o: CFLAGS += -Ireplacement/shipPlusPlus
replacement/shipPlusPlus/%.o: CXXFLAGS += -Ireplacement/shipPlusPlus
replacement/shipPlusPlus/%.o: CXXFLAGS +=  -Dinitialize_replacement=repl_rreplacementDshipPlusPlus_initialize -Dfind_victim=repl_rreplacementDshipPlusPlus_victim -Dupdate_replacement_state=repl_rreplacementDshipPlusPlus_update -Dreplacement_final_stats=repl_rreplacementDshipPlusPlus_final_stats
obj/repl_rreplacementDshipPlusPlus.a: $(patsubst %.cc,%.o,$(wildcard replacement/shipPlusPlus/*.cc)) $(patsubst %.c,%.o,$(wildcard replacement/shipPlusPlus/*.c))
	@mkdir -p $(dir $@)
	ar -rcs $@ $^
...
-include $(wildcard replacement/shipPlusPlus/*.d)
